...
export default async function  SidebarCategories ()  {
  ...
  return (
    <div className="col-span-full sm:col-span-3 bg-white border border-gray-200 rounded-lg sm:p-6 dark:bg-gray-800 dark:border-gray-700  text-slate-800 overflow-hidden shadow-md">
